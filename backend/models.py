...
# activity_tag 허용값 상수
# =============================================================================
# receipt_items.activity_tag 컬럼에 저장되는 값
# late_snack 은 paid_at 22시 이후 조건으로 쿼리 파생 → DB 저장 안 함
# caffeine / alcohol 은 db_mapper.ACTIVITY_RULES 키워드 매칭으로 자동 태깅
ACTIVITY_TAGS = ("caffeine", "alcohol", "late_snack")
